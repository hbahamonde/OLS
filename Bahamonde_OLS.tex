...
\begin{enumerate}
	...
	\item Introduction to lineal models in \texttt{R}.
 	\item Causal inference in \texttt{R}---time permitting.
  \item MLE for GLMs in \texttt{R}---time permitting (not included in this syllabus).
\end{enumerate}


\subsection*{Programming}

We will learn to program in \texttt{R}, the most-used programming language in social sciences. There are many things to like about this software. \texttt{R} is free and runs on all platforms. Second, it's an object-oriented language. This implies---third---that \texttt{R} forces the student to think hard about what s/he is doing. Unlike other statistical packages such as \texttt{Stata} or \texttt{SPSS}, where the user ``clicks and points,'' you have to tell \texttt{R} specifically \emph{what} you need and \emph{how} you need it. Fourth, if you know \texttt{R}, you can easily learn about other pieces of software.
\\
\\
...
\begin{enumerate}
	...
	\\
  \\
   There will be two quizzes. {\bf The first one is due at the beginning of the second session!} Both are due in hard copy (i.e. paper). Pen and paper is fine, but \LaTeX\; is best.
	...
	\item {\color{ForestGreen}{\bf Basic Functions in \texttt{R}}}
          ...
          %\item[$\circ$] \emph{Qu\'e es \texttt{Stata}?}
			...
			\begin{itemize} 
				...
				\begin{itemize} 
					...
					\item[$\circ$] {\bf Reading(s)}: 
					\begin{itemize}
						\item[$\diamond$] \textcite{Fox2011a}: 1.1.
					\end{itemize}
				\end{itemize}
			\end{itemize}
        ...
        \item[$\circ$] {\bf Reading(s)}: 
          \begin{itemize}
            ...
            \item[$\diamond$] \textcite{Fox2011a}: 2.3 and 3.4.
          \end{itemize}
					\end{itemize}
					% Monogan2015 Ch 2, 
			\end{itemize}
			...
			\begin{itemize} 
				\item[$\bullet$] {\bf Lesson \# 4} % original Lesson \#4
					\begin{itemize} 
						...
						\item[$\circ$] {\bf Reading(s)}:
							\begin{itemize}
								\item[$\diamond$] \textcite{Fox2011a}: 3.2.
							\end{itemize}
					\end{itemize}
			\end{itemize}
			...
			%	\item[$\circ$] {\bf Reading(s)}: 
			%		\begin{itemize}
			%			\item[$\diamond$] \textcite{Fox2011a}: 7.3.
			%		\end{itemize}
			%		\end{itemize}
			%\end{itemize}
...
% Monogan2015 Ch. 10.3.2
			...
			\begin{itemize} 
                ...
                \item[$\diamond$] \textcite{Fox2011a}: 4.3 till p. 177.
			...
			\begin{itemize} 
                ...
                \item[$\diamond$] \textcite{Fox2011a}: 4.3.1.
...
%\item[{\color{red}\Pointinghand}] Problem set \#2. Turn it in next class.
			...
			\begin{itemize} 
				\item[$\bullet$] {\bf Lesson \# 13} % original Lesson \#15
					\begin{itemize} 
			...
			\begin{itemize} 
				\item[$\bullet$] {\bf Lesson \# 14} % original Lesson \#16
					\begin{itemize} 
			...
			\begin{itemize} 
				\item[$\bullet$] {\bf Lesson \# 15} % original Lesson \#17
					\begin{itemize} 
...
%\item[{\color{red}\Pointinghand}] Problem set \#3. Turn it in next class.
  ...
  \item {\color{ForestGreen}{\bf Causal Inference in \texttt{R}}} (if time permits)
      ...
      \begin{itemize} 
        \item[$\bullet$] {\bf Lesson \# 16} % original Lesson \#18
          \begin{itemize} 
      ...
      \begin{itemize} 
        \item[$\bullet$] {\bf Lesson \# 17} % original Lesson \#19
          \begin{itemize} 
...
%\item[{\color{red}\Pointinghand}] Problem set \#4. Turn it in next class.
      ...
      \begin{itemize} 
        \item[$\bullet$] {\bf Lesson \# 18} % original Lesson \#20
          \begin{itemize} 
      ...
      \begin{itemize} 
        \item[$\bullet$] {\bf Lesson \# 19} % original Lesson \#21
          \begin{itemize} 
      ...
      \begin{itemize} 
        \item[$\bullet$] {\bf Lesson \# 20} % original Lesson \#22
          \begin{itemize} 
